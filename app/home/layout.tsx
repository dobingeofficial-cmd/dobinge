...
function HomeLayoutInner({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ minHeight: "100vh", backgroundColor: "#08070D", color: "#ffffff", display: "flex", width: "100%", overflowX: "hidden", position: "relative" }}>
      ...
      {/* ── 🎬 MAIN CONTENT (Structurally padded to protect nav zone) ── */}
      <div style={{ flex: 1, display: "flex", flexDirection: "column", paddingLeft: "104px", paddingRight: "32px", width: "100%", position: "relative", zIndex: 1, boxSizing: "border-box" }}>
        ...
        >
          ...
          >
            ...
            <div style={{ position: "absolute", left: "50%", transform: "translateX(-50%)", display: "flex", alignItems: "center", justifyContent: "center", pointerEvents: "none" }}>
              <span style={{ fontSize: "10px", fontWeight: 800, letterSpacing: "0.25em", textTransform: "uppercase", color: "rgba(255, 255, 255, 0.4)", whiteSpace: "nowrap", display: "flex", alignItems: "center", gap: "8px" }}>
