...
// 🚨 ARCHITECTURE FIX: Restored the exported TMDBMedia interface so ai-assistant-modal.tsx and other components compile successfully.
export interface TMDBMedia {
  ...
  media_type?: string;
  genre_ids?: number[];
  [key: string]: any; // Safeguard to accept any other TMDB data fields passed by other components
}
