...
export default function AuthView() {
  ...
  useEffect(() => {
    ...
    const fetchPosters = async () => {
      try {
        ...
        // Deep duplication to ensure dense matrix for the 10 columns
  ...
  // 🚨 10 columns for the perfect 30% scaled poster size
  const columns = Array.from({ length: 10 }, (_, i) => 
    posters.filter((_, index) => index % 10 === i)
  );

  return (
    <div style={{ position: "relative", width: "100%", height: "100%", minHeight: "100vh", backgroundColor: "#08070D", overflow: "hidden", display: "flex", alignItems: "center", justifyContent: "center" }}>
