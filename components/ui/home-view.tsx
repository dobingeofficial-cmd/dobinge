...
export default function HomeView({ onSelectMedia, setView }: HomeViewProps) {
  ...
  // 🚨 ARCHITECTURE UPGRADE: View All Deep-Dive State
  ...
  // 🚨 AI VIBE ENGINE: Contextual Hook Generation
  const aiVibeGrid = trendingGlobal.slice(3, 7);
  const aiVibeReasons = [
    "Because you watched Rec (2007)",
  ...
  return (
    <>
      <style>{`
        ...
        /* 🚨 ARCHITECTURE UPGRADE: 5-Poster Cinematic Ratio Engine */
              ...
              <AnimatePresence mode="wait">
                {activeTab === "all" ? (
                  ...
                  >
                    ...
                    {/* 🚨 ARCHITECTURE UPGRADE: View All Deep-Dive Matrix Rendering */}
                    {viewAllContext ? (
                      <motion.div 
                        initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -20 }}
                        style={{ width: "100%", display: "flex", flexDirection: "column", gap: "24px" }}
                      >
                        <div style={{ display: "flex", alignItems: "center", gap: "24px", position: "sticky", top: 0, paddingTop: "12px", backgroundColor: "rgba(5,2,10,0.9)", backdropFilter: "blur(20px)", zIndex: 100, paddingBottom: "16px", borderBottom: "1px solid rgba(255,255,255,0.05)" }}>
                          <motion.div 
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(180px, 1fr))", gap: "32px 20px", paddingBottom: "60px" }}>
                          <AnimatePresence>
                              ...
                              <div key={idx} style={{ width: "100%" }}>
                                ...
                                <div style={{ display: "flex", alignItems: "baseline", gap: "16px", marginBottom: "20px", paddingRight: "44px" }}>
                                  ...
                                  <div style={{ display: "flex", gap: "12px", marginLeft: "auto" }}>
                                    <div onClick={() => carousel.ref.current?.scrollBy({ left: -320, behavior: "smooth" })} style={{ width: "32px", height: "32px", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", cursor: "pointer" }}>
                                      <svg width="14" height="14" fill="none" stroke="#fff" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" /></svg>
                                    </div>
                                    <div onClick={() => carousel.ref.current?.scrollBy({ left: 300, behavior: "smooth" })} style={{ width: "32px", height: "32px", borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center", backgroundColor: "rgba(255,255,255,0.04)", border: "1px solid rgba(255,255,255,0.08)", cursor: "pointer" }}>
                                      <svg width="14" height="14" fill="none" stroke="#fff" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M9 5l7 7-7 7" /></svg>
                                    </div>
                                  </div>
                                </div>
